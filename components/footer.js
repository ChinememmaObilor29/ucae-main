...
export default function Footer() {
  ...
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-gray-100 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              {" "}
              <Link href="/" className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                    <Image
                      src="/img/WhatsApp Image 2024-02-03 at 19.23.09_1b9b2ddf.jpg"
                      alt="N"
                      width="32"
                      height="32"
                      className="w-8"
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-500">
          ...
          <div className="">
            <div>Follow us</div>
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-400">
              <a
                href=""
                target="_blank"
                rel="noopener">
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-600">
         Made with ♥ by{" "}
          <a
            href=""
            target="_blank"
